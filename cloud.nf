include { CLOUD_AUTHENTICATE; CLOUD_BWA_ALIGN; CLOUD_SORT; CLOUD_MARK_DUPLICATES; CLOUD_BQSR; CLOUD_BAM_OBSERVATIONS; CLOUD_BAM_GATE; CLOUD_GATK_CALL; CLOUD_DEEPVARIANT_CALL; CLOUD_PREPARE_TRUTH; CLOUD_NORMALIZE; CLOUD_INCLUDE; CLOUD_COMPRESS; CLOUD_RTG_REFERENCE; CLOUD_VCFEVAL; CLOUD_COLLECT } from './modules/cloud/tasks'
