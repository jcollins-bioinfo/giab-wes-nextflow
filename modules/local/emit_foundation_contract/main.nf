process EMIT_FOUNDATION_CONTRACT {
    ...
    {"schema_version":"1.0.0","pipeline_version":"0.2.0-dev.4","status":"foundation_only","fixture":"synthetic_nonhuman","input_manifest_sha256":"${hash}","caller_contract":"${callers}","nextflow_version":"${nfver}","profile":"${profile}","biological_processing":false,"benchmark_result":false}
    JSON
    """
}
