...
| DeepVariant CPU Linux/amd64 | [Pinned M4 image/model declarations](orchestration/evidence/m4-container-declaration.json) | M4 implemented; real runtime tests pending; actual inference not yet established |
